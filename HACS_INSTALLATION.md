...
/hacsfiles/ha-reachy-mini-card/assets/robot-3d/meshes/*.stl
```
...
1. 清除浏览器缓存并强制刷新。
2. 浏览器直接打开：
   - `http://homeassistant.local:8123/hacsfiles/ha-reachy-mini-card/ha-reachy-mini-card.js`
   - `http://homeassistant.local:8123/hacsfiles/ha-reachy-mini-card/assets/robot-3d/reachy-mini.urdf`
...
A: HACS 安装统一使用 `/hacsfiles/ha-reachy-mini-card/...`；手动安装通常使用 `/local/ha-reachy-mini-card/dist/...`。
